...
grenades = {
    1: Grenade(1, "Frag Grenade", damage=1000, blast_radius=200, fuse_time=3, effect_time=1, sprite_file="frag_grenade.png", proxy=False),
    2: Grenade(2, "Proximity Grenade", damage=800, blast_radius=200, fuse_time=5, effect_time=1.5, sprite_file="prox_grenade.png", proxy=True),
